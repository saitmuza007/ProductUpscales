...
const HomePage = () => {
    ...
    const purchase = (product) => {
        ...
        if (currentUser?.id==1) {
            setErrorMessage('Admin Is Not Allowed To Purcahses');
            return;
        }
        ...
        PurchaseService.savePurchase(purchase).then(() => {
            setInfoMessage('You Have Sucssfully Bought Your First Project Template...Enjoy Customizing');
        }).catch((err) => {
            ...
            <div className="d-flex flex-wrap">
                {productList.map((item, ind) =>
                    <div key={item.id} className="card m-3 home-card">
                        ...
                        <div className="ms-auto me-auto product-icon">
                            <img src={item.link} alt="Not found" />
                        </div>
                        <br />
